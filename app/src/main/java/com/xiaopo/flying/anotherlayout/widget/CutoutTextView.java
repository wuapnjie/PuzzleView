package com.xiaopo.flying.anotherlayout.widget;
...
import com.xiaopo.flying.kits.FontKit;
...
public class CutoutTextView extends View {
  ...
  public CutoutTextView(Context context, AttributeSet attrs) {
    ...
    if (a.hasValue(R.styleable.CutoutTextView_font)) {
      textPaint.setTypeface(FontKit.get(context, a.getString(R.styleable.CutoutTextView_font)));
    }
   ...
   */
  private float getSingleLineTextSize(String text, TextPaint paint, float targetWidth, float low,
  ...
  private void calculateTextPosition() {
    ...
    textSize = getSingleLineTextSize(text, textPaint, targetWidth, 0f, maxTextSize, 0.5f,
