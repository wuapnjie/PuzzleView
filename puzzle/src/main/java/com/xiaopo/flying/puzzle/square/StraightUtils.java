...
class StraightUtils {
  ...
  static StraightLine createLine(final SquareArea area, final Line.Direction direction,
      final float ratio) {
  ...
  static List<SquareArea> cutArea(final SquareArea area, final StraightLine line) {
    List<SquareArea> list = new ArrayList<>();
    if (line.direction() == Line.Direction.HORIZONTAL) {
      SquareArea one = new SquareArea(area);
      one.lineBottom = line;
      list.add(one);

      SquareArea two = new SquareArea(area);
      two.lineTop = line;
      list.add(two);
  ...
  static List<SquareArea> cutArea(final SquareArea area, final StraightLine l1,
    ...
    if (direction == Line.Direction.HORIZONTAL) {
      ...
      SquareArea three = new SquareArea(area);
      three.lineRight = l3;
      three.lineTop = l1;
      three.lineBottom = l2;
      list.add(three);

      SquareArea four = new SquareArea(area);
      four.lineLeft = l3;
      four.lineTop = l1;
      four.lineBottom = l2;
      list.add(four);

      SquareArea five = new SquareArea(area);
      five.lineRight = l3;
      five.lineTop = l2;
      list.add(five);

      SquareArea six = new SquareArea(area);
      six.lineLeft = l3;
      six.lineTop = l2;
      list.add(six);
    } else if (direction == Line.Direction.VERTICAL) {
  ...
  static List<SquareArea> cutArea(final SquareArea area, final StraightLine l1,
    ...
    if (direction == Line.Direction.HORIZONTAL) {
      ...
      SquareArea seven = new SquareArea(area);
      seven.lineRight = l4;
      seven.lineTop = l3;
      list.add(seven);

      SquareArea eight = new SquareArea(area);
      eight.lineLeft = l4;
      eight.lineTop = l3;
      list.add(eight);
    } else if (direction == Line.Direction.VERTICAL) {
  ...
  static List<SquareArea> cutArea(final SquareArea area, final StraightLine l1,
    ...
    SquareArea nine = new SquareArea(area);
    nine.lineLeft = l4;
    nine.lineTop = l2;
    list.add(nine);
  ...
  static List<SquareArea> cutAreaCross(final SquareArea area, final StraightLine horizontal,
